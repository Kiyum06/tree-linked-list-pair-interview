public class RedQ1 {
    /**
     * Given a reference to a head node in a linked list of integers, return the sum
     * of all the elements in the list at odd indexes. Assume the head is at index
     * 0.
     * Example:
